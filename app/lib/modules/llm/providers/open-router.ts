...
export default class OpenRouterProvider extends BaseProvider {
  ...
  staticModels: ModelInfo[] = [
    ...
    { name: 'x-ai/grok-beta', label: 'xAI Grok Beta (OpenRouter)', provider: 'OpenRouter', maxTokenAllowed: 4000 },
    {
    ...
    { name: 'cohere/command', label: 'Cohere Command (OpenRouter)', provider: 'OpenRouter', maxTokenAllowed: 4000 },
  ];
